...
def generate_launch_description():
    ...
    world_file = os.path.join(
        get_package_share_directory(pkg_name), "worlds", "box_fort.sdf"
    )
    ...
    gz_bridge_node = Node(
        package="ros_gz_bridge",
        executable="parameter_bridge",
        # The syntax is: /topic_name@ROS2_Type[Gazebo_Type
        # The '[' bracket means data flows FROM Gazebo TO ROS 2
    ...
    # --- AMCL & NAV2 BRINGUP ---
    # We change 'navigation_launch.py' to 'bringup_launch.py'.
    # This automatically starts AMCL, Map Server, and Navigation all together!
