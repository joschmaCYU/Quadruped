...
/ --- CONFIGURATION ---
onst int servoPins[8] = {13, 14, 15, 16, 17, 18, 19, 21}; 
ervo servos[8];
onst int ledPin = 2; 

/ --- MICRO-ROS OBJECTS ---
cl_subscription_t subscriber;
td_msgs__msg__Float64MultiArray msg; // UPDATED FOR GAZEBO
...
/ --- CALLBACK ---
oid subscription_callback(const void * msgin) {
 const std_msgs__msg__Float64MultiArray * incoming_msg = (const std_msgs__msg__Float64MultiArray *)msgin;
